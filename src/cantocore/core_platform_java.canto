...
core {
    ...
    file_interface file_impl(file_interface fbase, path),(base, path),(base) = canto.runtime.Utils.getFunFile(fbase, base, path)
    ...
    dynamic log(str) = canto.runtime.SiteBuilder.log(str)

    /** sends a string to log file/console if Fun is running in
     *  verbose mode.
     **/
    dynamic vlog(str) = canto.runtime.SiteBuilder.vlog(str)
    ...
    dynamic err(str) = canto.runtime.SiteBuilder.err(str)
